...
// QorTroller — Partner Brief (tab 07).
//
// Renders the self-contained manufacturer/partner pitch deck
// (frontend/public/qortroller-partner-pitch.html) full-bleed in an iframe. Same
// EvidenceOS design system as the Grant Brief (Syne + JetBrains Mono, void-black
// #04060a graticule, medial-T amber #f0a868 wordmark, chain-green #5bd6a3 data;
// 12 slides + speaker notes driven by /deck-stage.js). Public, no auth — sharable
// with hardware partners (Qorvo / Boréas / Battle Beaver) who hold no operator
// credentials. Honest measured-vs-proposed throughout; C7 aspirational-primary;
// re-ranked partner table; FTO caveat.
export function PartnerPitchView() {
  useViewEyebrow({
    num: '07', name: 'PARTNER · BRIEF', status: 'OUTREACH', statusTone: 'amber',
    readouts: [{ label: 'SLIDES', value: '12', tone: 'chain' }, { label: 'NAV', value: '? = KEYS', tone: 'dim' }],
  })
  ...
  return (
    <div style={{ position: 'relative', flex: 1, minHeight: 0, width: '100%', background: '#000' }}>
      <iframe
        ...
        title="QorTroller — Partner Brief"
        style={{
          position: 'absolute',
          inset: 0,
          width: '100%',
