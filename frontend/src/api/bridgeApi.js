...
// noMock:true (connectivity-critical): a transient 5xx must never swap in a fabricated "live"
// connect-state. On failure react-query holds the last real value; a full outage surfaces the
// explicit MOCK banner via the first-load path, never a fake green.
