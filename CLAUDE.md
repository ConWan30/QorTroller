...
~254 files, ~2,025 automated tests total (~1,988 CI excluding 37 hardware, 14 E2E).
Bridge: 1496 passing. Contract: 440. SDK: 133. Hardware: 37. E2E: 14.
38 contracts ALL LIVE (32 legacy + 6 Phase 99A/B/C deployed 2026-03-21). See `contracts/deployed-addresses.json`.
Active wallet (bridge + deployer): `0x0Cf36dB57fc4680bcdfC65D1Aff96993C57a4692` (~4.6 IOTX as of 2026-03-21)
...
Current phase: Phase 110 — COMPLETE (IoSwarm VHP Mint Authorization — Fail-CLOSED Quorum Gate; Bridge 1488→1496 +8; SDK 129→133 +4)
