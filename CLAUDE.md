...
~270 files, ~3,169 automated tests total (~3,118 CI excluding 37 hardware, 14 E2E).
Bridge: 2260 passing. Contract: 482. SDK: 452. Hardware: 37. E2E: 14.
NOTE: 16 pre-existing SDK version-check failures. Bridge empirical pass count ~2300 (106 pre-existing failures from phases 55/56/58/69/186/187/191; ioSwarm+env-sensitive tests may vary; measured 2026-04-14 post Phase 208).
...
- **CURRENT STATE (2026-04-11, UPDATED): N=35 — RATIO DECLINED, touchpad_corners protocol ceiling hit**
  ...
  - **tremor_seed corpus (2026-04-12)**: P1=10/P2=8/P3=6 sessions; separation ratio=0.748 (diagonal+LOO, N=24); LOO accuracy=45.8% (11/24); only micro_tremor_accel_variance active; tremor_peak_hz=0 pre-Phase-205 (right_stick_x=128 neutral); Phase 205 AccelTremorFFT fix: tremor_resting sessions now produce non-zero tremor_peak_hz from IMU accel FFT; 4/13 features active vs 10/13 gameplay (pre-205); post-205 tremor_resting should activate tremor_peak_hz + micro_tremor_accel_variance
