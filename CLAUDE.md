...
~270 files, ~3,030 automated tests total (~2,979 CI excluding 37 hardware, 14 E2E).
Bridge: 2142 passing. Contract: 482. SDK: 394. Hardware: 37. E2E: 14.
...
Active wallet (bridge + deployer): `0x0Cf36dB57fc4680bcdfC65D1Aff96993C57a4692` (~6.6 IOTX after Phase 187 deploy 2026-04-10; all 4 deferred contracts now live)
...
- **CURRENT STATE (2026-04-11): N=29 — TREND REVERSED, ratio approaching 1.0**
  - Separation ratio: **0.998** (diagonal+LOO, N=29, P1=8/P2=11/P3=10; 2026-04-11 analysis)
  - **STILL TOURNAMENT BLOCKER**: ratio 0.998 < 1.0 target; but trend REVERSED: N=20→0.569, N=29→0.998 (+0.429)
  - LOO classification: **48.3% (14/29)** — above random baseline (33%); major improvement from 20.0%
  - **Root cause (P1)**: intra-player variance (range=[0.155,1.592]); tremor_peak_hz P1=12.083Hz vs P2=0.798Hz vs P3=2.113Hz — P1 is primary discriminator; temporal non-stationarity improving
  ...
  - **Path to >1.0**: P1 needs 2 more touchpad_corners sessions. Ratio at 0.998 — 2 sessions likely cross 1.0
