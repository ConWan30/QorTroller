...
| LUMEN-4a | Trio pipeline offline over archives (trio-retina v0.3.0 INSTALLED — MachineFi/IoTeX Apache-2.0 — + trio-core detector; M13/M14 crops -> first non-null retina_perception_root CANDIDATE; zero rig) | QUEUED (2026-07-07: IoTeX announced Trio-Lumen product — RTSP + plain-English queries; NOT open-sourced yet, building blocks are; any hosted-Lumen feed of gameplay is consent-gated per LUMEN-5) | LUMEN-1 ✓ |
