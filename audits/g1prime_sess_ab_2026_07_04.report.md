...
Crops: **600** from `C:\Users\Contr\vapi-pebble-prototype\retina_kf_archive/sess_ab_1783138825`  ·  2078.0 ms/crop
...
- Instrument A OWN_KILL reads: **134**
- **Candidate false reads** (A=OWN_KILL contradicted by B seeing the handle in a non-killer slot): **4** — bar is ZERO after adjudication; see contact sheet.

## Per-instrument taxonomy
- A `ocr_row_v1` (killer-slot READER): {'UNRESOLVED': 466, 'OWN_KILL': 134}
- B `template_ensemble_v1` (template SCORER): {'OWN_DEATH': 100, 'UNRESOLVED': 61, 'OTHER_ROW': 211, 'OWN_KILL': 228}
- UNRESOLVED rate — A **77.7%** / B **10.2%** (pre-registered DRIFT ALARM: a rendering change spikes this before recall silently collapses)

## Disagreement report (the independence measurement)
{'B_KILL_A_MISS': 98, 'CONFLICT_A_KILL_B_ROSTER': 4}
...
B's OWN_KILLs by winning anchor: {'session_anchor:session_anchor_20260703_141526_5ec2595697e0aa6b.png': 56, 'session_anchor:session_anchor_20260703_075738_b0b9f31a24bb1e98.png': 12, 'session_anchor:session_anchor_20260703_232037_bd0f6fc026ff3957.png': 28, 'session_anchor:session_anchor_replay_39767eb130325aa4.png': 51, 'session_anchor:session_anchor_20260703_155058_b46bd348749c2ed5.png': 33, 'session_anchor:session_anchor_replay_5475493d35b3f719.png': 38, 'roster_v1': 1, 'session_anchor:session_anchor_20260704_130602_f973615d792637b9.png': 7, 'session_anchor:session_anchor_replay2_280a1f1513688989.png': 2}
...
- Crops neither instrument resolved (UNRESOLVED by BOTH): **61** — the deep tail where feed_v1 < 0.40 (A cannot locate) AND template < 0.66 (B sub-floor). This is the human_oracle contact-sheet input.
