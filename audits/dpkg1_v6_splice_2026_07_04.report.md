...
Crops: **600** from `C:\Users\Contr\vapi-pebble-prototype\retina_kf_adv_splice`  ·  3885.4 ms/crop
...
- Instrument A OWN_KILL reads: **80**
- **Candidate false reads** (A=OWN_KILL contradicted by B seeing the handle in a non-killer slot): **0** — bar is ZERO after adjudication; see contact sheet.

## Per-instrument taxonomy
- A `ocr_row_v1` (killer-slot READER): {'UNRESOLVED': 520, 'OWN_KILL': 80}
- B `template_ensemble_v1` (template SCORER): {'OWN_DEATH': 309, 'OWN_KILL': 152, 'UNRESOLVED': 109, 'OTHER_ROW': 30}
- UNRESOLVED rate — A **86.7%** / B **18.2%** (pre-registered DRIFT ALARM: a rendering change spikes this before recall silently collapses)
...
B's OWN_KILLs by winning anchor: {'session_anchor:session_anchor_20260703_141526_5ec2595697e0aa6b.png': 152}
...
- Crops neither instrument resolved (UNRESOLVED by BOTH): **109** — the deep tail where feed_v1 < 0.40 (A cannot locate) AND template < 0.66 (B sub-floor). This is the human_oracle contact-sheet input.
