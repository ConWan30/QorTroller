...
class Config:
    ...
    cco_phase_g_validated_tiers: str = field(
        default_factory=lambda: _env("CCO_PHASE_G_VALIDATED_TIERS", "")
    )
    """Comma-separated Phase G tiers operator-attested VALIDATED after FAR/FRR review."""
