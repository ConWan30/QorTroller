...
class TestEdgeAIProfile(unittest.TestCase):
    ...
    def test_2_agent_fleet_size_is_22(self):
        """agent_fleet_size == 22 (22-agent autonomous fleet — agents #21-22 added Phases 157+159)."""
        result = get_edge_ai_profile()
        self.assertEqual(result["agent_fleet_size"], 22)
